    ...
    def group(self, groupname,funcRoutes):
        for funcs in funcRoutes:
            ...
            if funcs["method"].lower() == "get":
                self.get("/" + groupname+"/"+funcs["endpoint"], funcs["controller"], funcs["func"], middleware,endpoint_clear)
            if funcs["method"].lower() == "post":
                self.post("/" + groupname + "/" + funcs["endpoint"], funcs["controller"], funcs["func"], middleware,endpoint_clear)
